...
class pid:
  ...
  def start(self):
    ...
    while not rospy.is_shutdown():
        ...
        print("pitch")
        print(self.pitch)
        self.PID_pitch = self.getPID(self.kd_pitch, self.ki_pitch, self.kp_pitch, self.pitch, 0, self.pid_i_pitch, self.angvel_x, 0)
        self.PID_roll = self.getPID(self.kd_roll, self.ki_roll, self.kp_roll, self.roll, 0, self.pid_i_roll, self.angvel_y, 0)
  ...
  def getPID(self, kd, ki, kp, actual, desired, pid_i, angvel, prev_vel):
